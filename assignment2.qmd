...
assignment <- c('Wiki on Environmental Justice', 'EJScreen Exploration',
                ...
                'Importing Data in R - RMRWR - Chapter 5.1 and 5.2', 'Map 2 or 3 planned warehouses')
due.Date <- c('February 8, 2023', 'February 10, 2023', 'February 10, 2023', 'February 15, 2023', 'February 17, 2023', 'February 22, 2023', 'February 24, 2023')
source <- c('https://en.wikipedia.org/wiki/Environmental_justice',
            ...
            'https://docs.google.com/spreadsheets/d/1Ev8455_HqftMlcxs9o7hbe3eip9SgOMomG5KHI9XlBs/edit#gid=249291926')
...
Assignment is currently due **March 1st, 2023** at the beginning of class (9:45 AM). Please send the `.R script` and an exported visualization via email. This assignment is worth 100 points. Coding style will not be graded. Scripts will be used to reproduce the figure on my local machine - deviations between code and exported figure will likely result in deducted points.
